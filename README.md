...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/deepchem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9079&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/deepchem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `deepchem` can be installed with:

```
conda install deepchem
```

It is possible to list all of the versions of `deepchem` available on your platform with:
